    ...
    return (
        <main className="min-h-[calc(100vh-80px)] bg-brand-cream py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden p-8">
                <Link href="/signup" className="inline-flex items-center text-brand-red font-medium hover:underline mb-8">
                    <ArrowLeft size={16} className="mr-2" />
                    Back to choices
                </Link>

                <div className="flex items-center gap-4 mb-8">
                    <div className="w-12 h-12 bg-[#FEE2E2] rounded-xl flex items-center justify-center text-brand-red">
                        <User size={24} />
                    </div>
                ...
                <form action={formAction} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand-red focus:border-transparent transition-all outline-none"
                        ...
                        <div>
                            ...
                            <select
                                name="gender"
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-brand-red focus:border-transparent transition-all outline-none appearance-none bg-white"
                            >
                    ...
                    <button
                        type="submit"
                        disabled={isPending}
                        className="w-full bg-brand-red text-white font-bold py-4 rounded-xl hover:bg-opacity-90 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center disabled:opacity-50 disabled:transform-none"
                    >
                        {isPending ? (
                            <>
